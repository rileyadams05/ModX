...
Community cheat tables are not stored in the Vortex Prime website. Valid uploads are written to this ModX repository under `tables/`, while catalogue metadata is served by the ModX API.
